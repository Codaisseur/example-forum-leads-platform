...
ActiveRecord::Schema.define(version: 20160905194319) do
  ...
  add_foreign_key "painting_leads", "locations"
  add_foreign_key "painting_leads", "service_types"
  add_foreign_key "received_painting_leads", "artists"
  add_foreign_key "received_painting_leads", "locations"
  add_foreign_key "received_painting_leads", "painting_leads"
end
